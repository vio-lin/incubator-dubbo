...
public class MetadataTest {
    ...
    public void testInnerClassType() {
        ...
        Assertions.assertEquals(DefaultTypeBuilder.class.toString(), td.getTypeBuilderName());
    ...
    public void testRawMap() {
        ...
        Assertions.assertEquals(MapTypeBuilder.class.toString(), td.getProperties().get("map").getTypeBuilderName());
        Assertions.assertEquals("java.util.List", td.getProperties().get("list").getType());
        Assertions.assertEquals(CollectionTypeBuilder.class.toString(), td.getProperties().get("list").getType());
    ...
    public void testEnum() {
        ...
        Assertions.assertEquals(EnumTypeBuilder.class.toString(), td.getTypeBuilderName());
    ...
    public void testExtendsMap() {
        ...
        Assertions.assertEquals(MapTypeBuilder.class.toString(), td.getTypeBuilderName());
